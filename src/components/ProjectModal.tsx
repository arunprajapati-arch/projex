    ...
    >
      ...
      >
          ...
          <div className="absolute bottom-3 left-4 right-4 sm:bottom-4 sm:left-6 sm:right-6">
            {isEditing ? (
              <input 
                ...
                className="text-xl sm:text-2xl font-bold w-full bg-neutral-800/70 text-white border border-purple-500/30 rounded px-3 py-1"
              />
            ) : (
        ...
        <div className="flex border-b border-neutral-800 bg-neutral-900/95 overflow-x-auto thin-scrollbar-x">
          <button 
            className={`px-2 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium transition-colors flex items-center space-x-1 sm:space-x-2 ${activeTab === 'overview' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-neutral-400 hover:text-white'}`}
          ...
          <button 
            className={`px-2 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium transition-colors flex items-center space-x-1 sm:space-x-2 ${activeTab === 'progress' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-neutral-400 hover:text-white'}`}
          ...
          <button 
            className={`px-2 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium transition-colors flex items-center space-x-1 sm:space-x-2 ${activeTab === 'timeline' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-neutral-400 hover:text-white'}`}
          ...
          <button 
            className={`px-2 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium transition-colors flex items-center space-x-1 sm:space-x-2 ${activeTab === 'tasks' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-neutral-400 hover:text-white'}`}
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                {isEditing ? (
                  <textarea 
                    ...
                    className="w-full bg-neutral-800 text-white border border-purple-500/30 rounded p-2 sm:p-3 h-24 sm:h-32"
              ...
              <div>
                ...
                <div className="flex space-x-1 sm:space-x-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-purple-600 rounded-full flex items-center justify-center text-white text-xs">AB</div>
          ...
          {activeTab === 'timeline' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="relative border-l-2 border-neutral-700 ml-2 sm:ml-3 space-y-6 sm:space-y-8 py-2">
                ...
                <div className="relative pl-6 sm:pl-8">
                  <div className="absolute -left-2.5 sm:-left-3 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-purple-500 border-3 sm:border-4 border-neutral-900"></div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center bg-neutral-800/50 p-2 sm:p-3 rounded-lg border border-neutral-700 text-xs sm:text-sm">
                  <input type="checkbox" className="mr-2 sm:mr-3 h-3 w-3 sm:h-4 sm:w-4 accent-purple-500" checked />
                ...
                <div className="flex items-center bg-neutral-800/50 p-2 sm:p-3 rounded-lg border border-neutral-700 text-xs sm:text-sm">
                  <input type="checkbox" className="mr-2 sm:mr-3 h-3 w-3 sm:h-4 sm:w-4 accent-purple-500" />
        ...
        <div className="border-t border-neutral-800 p-3 sm:p-4 flex flex-wrap sm:flex-nowrap gap-2 justify-between items-center bg-neutral-900/95">
          ...
          {isEditing ? (
            <div className="flex space-x-2 order-1 sm:order-2 w-full sm:w-auto">
              ...
              <Button size="sm" className="bg-purple-600 text-white hover:bg-purple-700 flex items-center space-x-1 text-xs flex-1 sm:flex-auto justify-center" onClick={handleSave}>
                <Save className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
                <span>Save Changes</span>
              </Button>
            </div>
          ) : (
            <Button size="sm" className="bg-purple-600 text-white hover:bg-purple-700 text-xs order-1 sm:order-2 w-full sm:w-auto" onClick={() => setIsEditing(true)}>
              Edit Project
            </Button>
          )}
        </div>
